...
function confirm_delete(id)
{
 ...
 {
  window.location.href='deleteItems.php?del='+id;
 }
 else{window.location.href='AdminViewItems.php';}
}
</script>
</head>
...
<div id="nav">
<ul>
  <li><a class="active" href="#">All Items</a></li>
...
echo " <table border='2' cellpadding='5'><tr>  <th width='20%'>Item Type</th> <th width='20%'>Name/Number</th> <th width='20%'>Place Found</th> <th width='20%'>Status</th> <th width='20%' colspan='2'></th>  </tr>";
...
<td>  <a href='editItems.php?edit=$row[sr]'>Edit</a></td>
