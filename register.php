...
<ul>
  <li><a class="active" href="#">Add Items</a></li>
...
<table>
<tr> <td>Item Type</td> <td> <select id='in' name='type'>
...
<tr> <td> Number/Name</td> <td><input type='text' name='name' id='in' placeholder='Specific Identification of Item' required/></td></tr>
<tr> <td> Place Found</td> <td><input type='text' name='place' id='in' placeholder='Place Found' required/></td></tr>
